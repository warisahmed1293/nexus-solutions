...
const looped_images = [...brand_images, ...brand_images, ...brand_images, ...brand_images, ...brand_images];
...
export default function BrandSlider() {
  return (
    <div className="tp-brand-slider-active fix">
      ...
      >
        {looped_images.map((b, i) => (
          <div key={i} className="tp-brand-item" style={{ marginRight: "40px" }}>
            <Image src={b} alt="" style={{ width: 150, height: 100, objectFit: "contain" }} />
          </div>
        ))}
      </Marquee>
    </div>
